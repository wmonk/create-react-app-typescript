...
_Do you know react and want to try out typescript? Or do you know typescript and want to try out react?_ Now you can get all the benefits from `create-react-app` _and_ use typescript! 🚀
